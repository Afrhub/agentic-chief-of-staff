...
export const DEMO_FLEET = [
  { axis: 'money', name: 'James', role: 'Finance Director', traits: ['numbers-first', 'calm under pressure', 'conservative', 'no vanity metrics'], watches: 'MRR, churn-driven revenue loss, failed-payment spikes, runway', model: 'claude-haiku-4-5', source: 'stripe', connectors: ['stripe'], tools: ['agent toolset (bash · files)', 'stripe (MCP)'], cadence: 'Hourly', avatar: '/avatars/james.png',
    lastFinding: { has_signal: true, type: 'churn_driven_revenue_loss', confidence: 0.78, summary: 'Churn 6% vs 5% target is bleeding ~$1,080/mo; MRR stuck $2K under the $20K goal despite a healthy pipeline.' } },
  { axis: 'customers', name: 'Sofia', role: 'Head of Customer Success', traits: ['empathetic', 'data-driven', 'retention-obsessed', 'hears churn early'], watches: 'cancellations, pre-churn behaviour, health-score and NPS drops', model: 'claude-haiku-4-5', source: 'intercom', connectors: ['intercom'], tools: ['agent toolset (bash · files)', 'intercom (MCP)'], cadence: 'Hourly', avatar: '/avatars/sofia.png',
    lastFinding: { has_signal: true, type: 'churn_signal', confidence: 0.85, summary: 'Churn risen to 6.0% against a 5.0% target (20% over) — retention erosion worth acting on.' } },
  { axis: 'comms', name: 'Marcus', role: 'Chief of Staff (gatekeeper)', traits: ['discerning', 'protects your attention', 'politically astute', 'fast triage'], watches: 'investor/VIP inbound, time-sensitive external asks, team friction', model: 'claude-sonnet-4-6', source: 'slack', connectors: ['slack', 'gmail', 'gcal'], tools: ['agent toolset (bash · files)', 'slack (MCP)', 'gmail (MCP)', 'gcal (MCP)'], cadence: 'Hourly', avatar: '/avatars/marcus.png',
    lastFinding: { has_signal: false, summary: 'Inbox and channels quiet — no investor/VIP inbound or escalation worth surfacing.' } },
  { axis: 'meetings', name: 'Priya', role: 'Executive Assistant', traits: ['meticulous', 'never drops a commitment', 'deadline-aware', 'reads subtext'], watches: 'commitments made, deadlines, risks and competitor mentions in meetings', model: 'claude-sonnet-4-6', source: 'granola', connectors: ['granola'], tools: ['agent toolset (bash · files)', 'granola (MCP)'], cadence: 'Hourly', avatar: '/avatars/priya.png',
    lastFinding: { has_signal: true, type: 'meeting_action', confidence: 0.72, summary: 'Open commitment: "deliver the updated metrics deck by Friday" — owner and status unconfirmed.' } },
  { axis: 'ops', name: 'David', role: 'Head of Operations', traits: ['reliability-first', 'process-minded', 'watches quiet failures', 'unflappable'], watches: 'uptime/incidents, hiring and people-runway, process breakdowns', model: 'claude-haiku-4-5', source: 'datadog', connectors: ['datadog'], tools: ['agent toolset (bash · files)', 'datadog (MCP)'], cadence: 'Hourly', avatar: '/avatars/david.png',
    lastFinding: { has_signal: false, summary: 'Uptime 99.95%, error rate flat, no incidents — nothing decision-worthy.' } }
];
